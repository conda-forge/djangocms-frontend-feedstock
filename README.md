About djangocms-frontend-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/djangocms-frontend-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/djangocms-frontend-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add djangocms-frontend
# for installing globally
pixi global install djangocms-frontend
```
...
It is possible to list all of the versions of `djangocms-frontend` available on your platform:
...
```
pixi search djangocms-frontend --channel conda-forge
```
